        ...
        <center><div class="desc">
            ...
            <table align="center">
                <tr>
                    ...
                    <td class="auto-style1 color=#D6CECD"><asp:TextBox ID="TextBox1" runat="server" placeholder="First Name" Height="32px" Width="185px" style="margin-left: 1px"></asp:TextBox></td>
               
                    
                    <td><asp:TextBox ID="TextBox2" runat="server" placeholder="Last Name" Height="32px" Width="200px"></asp:TextBox></td>
                </tr>
                <tr>
                    
                    <td class="auto-style1"><asp:TextBox ID="TextBox3" runat="server" placeholder="Email" TextMode="Email" Height="32px" style="margin-left: 0px" Width="215%"></asp:TextBox></td>
                </tr>
                <tr>
                    
                    <td><asp:TextBox ID="TextBox4" runat="server" placeholder="Password" TextMode="Password" Width="215%" Height="32px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td><asp:TextBox ID="TextBox5" runat="server" placeholder="Confirm Password" TextMode="Password" Width="215%" Height="32px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td><asp:Button ID="Button1" runat="server" style="font:bold" Text="Register" Height="35px" Width="220%" OnClick="Button1_Click1"></asp:Button></td>
                </tr>
